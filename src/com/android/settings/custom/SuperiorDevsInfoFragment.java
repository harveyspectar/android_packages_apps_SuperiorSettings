...
public class SuperiorDevsInfoFragment extends SettingsPreferenceFragment {
    ...
    private void showGitProfileIcons() {
		...
		getGithubIcon(R.string.maintainer_payton_git, findPreference("maintainer_payton"));
                getGithubIcon(R.string.maintainer_surya_git, findPreference("maintainer_phoenix"));
		getGithubIcon(R.string.maintainer_surya_git, findPreference("maintainer_surya"));
